...
public class TelaFornecedores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabelaFornecedores.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "CPNJ", "E-mail", "Telefone", "Celular", "Cep", "Endereço", "Nº", "Complemento ", "Bairro", "Cidade", "UF"
            }
        ));
...
new ComponentesPrograma().LimpaTela(paineldados);
    ...
    private void tabelaFornecedoresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaFornecedoresMouseClicked
        // pegar os dados e manda para os txtfield
    ...
    private void btnpesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnpesquisarActionPerformed
        ...
        FornecedoresDAO dao = new FornecedoresDAO();
        List<Fornecedores> lista = dao.listarFornecedoresPeloNome(nome);
        //criando o objeto que vai armazenar os dados dessa lista na tabela
        DefaultTableModel dados = (DefaultTableModel) tabelaFornecedores.getModel();
        dados.setNumRows(0);
        //cada item dessa lista vai adicionar uma linha
